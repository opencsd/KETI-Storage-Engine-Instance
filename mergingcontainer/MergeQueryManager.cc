            ...
            for(int f=0; f<snippet.table_filter_size(); f++){//동등조인,비동등조인 여부 판단 필요
                if(f%2 == 1){
                    ...
                    case TYPE_STRING:
                        ...
                        break;
                    default:
                        KETILOG::ERRORLOG("","inner join type check plz... " + to_string(driving_table.table_data[driving_c1].type));
                    }
